        ...
        >
          ...
          >
            ...
            >
              ...
              한해 공유하겠습니다. <br />
              <br />
              5. 개인정보를 포함한 회원의 정보를 이용하는 방법<br />
              5.1 회사는 상기 정보를 리뷰에 관련된 활동 (리뷰 작성, 리뷰 반응,
              리뷰 검색, 활동에 대한 보상)을 하는 사용자의 편의와 사용자에게
              적합한 서비스의 제공을 위해, 그리고 사용자를 이해, 사용자의 흥미와
              관심을 반영한 리뷰를 제공 등, 사용자를 위한 전반적인 서비스 환경의
              개선을 위해 사용합니다. 이에, 혹 회원께서 서비스 이용 중, 개인
              정보의 활용에 더 이상 동의하지 않으실 경우, 꼭 이메일로
              연락하시어, LITER 담당자에게 알려주셔야 합니다. 담당자가 이메일로
              요청을 받은 후, 회사는 회원에게 서비스 이용에 대한 제한을
              공지해드립니다. <br />
