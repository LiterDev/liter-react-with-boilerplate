...
function AppDrawer(props) {
  ...
  const avatarImg = (Boolean(localStorage.getItem('profileImageUrl') && localStorage.getItem('profileImageUrl') != 'null')? localStorage.getItem('profileImageUrl') : avatarDefault);
  const LiterCubeIcon = (
