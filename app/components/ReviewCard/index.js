        ...
        <Card className={classes.card}>
          ...
          <CardActions className={classes.actions} disableActionSpacing>
            <div className={classes.activeStatus}>
              ...
              <span className={classes.captionText}><FormattedMessage {...messages.rewardActive} /></span>
            </div>
            <div className={classes.activeRStatus}>
              <ShareIcon className={classes.shareicons}/>
              <span className={classes.shareText}><FormattedMessage {...messages.sharingText} /></span>
            </div>
            <div className={classes.activeRStatus}>
